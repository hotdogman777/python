...
# stu1 = df[df["이름"].isin(["서연", "지민"])]
# print("=== 실습 2-1 ===")
# print(stu1)
# print()
# df2 = stu1.reset_index(drop=True)
# print("=== 실습 2-2 ===")
# print(df2)
# print()
...
# print(df1)
# print()
# df2 = df[df["점수"] >= 70].reset_index(drop=True)
# print(df2)
# print()
...
# df = pd.concat([df, new_row], ignore_index=True)  # ignore_index=True는 결과의 인덱스를 0부터 재부여라는 뜻
# print(df)
# print()
...
# drop3 = df.drop(df[df["점수"] < 80].index)
# print(drop3)
# print()
...
# # (단, '키'라는 새 열이 자동으로 추가되어야 함) # concat 사용
# new_c = pd.DataFrame([{"이름": "c", "나이": 25, "키": np.nan}])
# df = pd.concat([df, new_c], ignore_index=True)
# print(df)
# print()
...
# df_drop = df.drop(df[df["인원"] <= 2].index)
# print(df_drop)
# print()
...
# # 출력하세요.
# df2 = df.sort_values(by="score", ascending=False, inplace=False)
...
df2 = df.groupby(["class", "subject"])["score"].agg(["count", "mean"])
print(df2)
print()
